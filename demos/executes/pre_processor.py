...
class PreProcessor(object):
    ...
    def execute(self, params):
        ...
        # 不同分类任务，选择不同预处理方式
        ret = None
        if flags.data_type == "shorttext":
            ret = self._pre_shorttext(flags)
        elif flags.data_type == "longtext_with_title":
            ret = self._pre_longtext_with_title(flags)
    ...
    def _pre_longtext_with_title(self, flags):
        # [titles, contents, labels]
        vocab_set, titles, conts, labels = TFUtils.load_longtext_with_title_data(
